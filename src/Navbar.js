  ...
  return (
    <nav className="navbar" style={{ position: 'fixed', width: '97%', backgroundColor: 'black', color: 'white', padding: '10px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      ...
      <div className="navbar-menu" style={{ display: 'flex' }}>
        <Link to="/find-home" className="navbar-menu-item" style={{ margin: '0px', textAlign: 'left', textDecoration: 'none', color: 'white', display: 'flex', flexDirection: 'column', alignItems: 'left' }}>
          <img src={FindHomeIcon} alt="Find Home" style={{ width: '86px', height: '60px' }} />
          <p style={{ margin: '0', fontSize: '14px' }}>Find a Home</p>
        </Link>
        <Link to="/invest" className="navbar-menu-item" style={{ margin: '0px', textAlign: 'left', textDecoration: 'none', color: 'white', display: 'flex', flexDirection: 'column', alignItems: 'left' }}>
          <img src={InvestIcon} alt="Invest" style={{ width: '86px', height: '60px' }} />
